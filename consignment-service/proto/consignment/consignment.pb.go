...
func (*Consignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_9f493c7602a40d35, []int{0}
}
...
func (*Container) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_9f493c7602a40d35, []int{1}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_9f493c7602a40d35, []int{2}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_9f493c7602a40d35, []int{3}
}
...
func init() {
	proto.RegisterFile("proto/consignment/consignment.proto", fileDescriptor_consignment_9f493c7602a40d35)
}

var fileDescriptor_consignment_9f493c7602a40d35 = []byte{
